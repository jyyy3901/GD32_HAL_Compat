...
| USART3 → GD USART2 | DMA0 CH1 / `GD32_DMA_REQUEST_USART2_TX` | DMA0 CH2 / `GD32_DMA_REQUEST_USART2_RX` |
| UART4 → GD UART3 | DMA1 CH4 / `GD32_DMA_REQUEST_UART3_TX` | DMA1 CH2 / `GD32_DMA_REQUEST_UART3_RX` |
| UART5 → GD UART4 | 不支持 | 不支持 |
