...
| I2C1/2 | I2C0/1 | 既有模块，0.9.0 只回归不扩张 |
| SPI1/2/3 | SPI0/1/2 | 既有模块，0.9.0 只回归不扩张 |
...
| `DMA_HandleTypeDef` | Instance、Init、Parent、Callback、State/ErrorCode、Stream 兼容字段 | GD32_INSTANCE、gd32_dma_periph、gd32_dma_channel、IRQ/resource |
