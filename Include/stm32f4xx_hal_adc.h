...
#define __HAL_ADC_ENABLE(__HANDLE__) \
    ((void)GD32_HAL_ADC_EnableAndCalibrate((__HANDLE__)->GD32_INSTANCE))
#define __HAL_ADC_DISABLE(__HANDLE__) \
    GD32_HAL_ADC_Disable((__HANDLE__)->GD32_INSTANCE)
#define __HAL_ADC_GET_FLAG(__HANDLE__, __FLAG__) \
    GD32_HAL_ADC_GetFlag((__HANDLE__)->GD32_INSTANCE, (__FLAG__))
#define __HAL_ADC_CLEAR_FLAG(__HANDLE__, __FLAG__) \
    GD32_HAL_ADC_ClearFlag((__HANDLE__)->GD32_INSTANCE, (__FLAG__))
#define __HAL_ADC_ENABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_ADC_SetInterrupt((__HANDLE__)->GD32_INSTANCE, (__INTERRUPT__), 1)
#define __HAL_ADC_DISABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_ADC_SetInterrupt((__HANDLE__)->GD32_INSTANCE, (__INTERRUPT__), 0)
#define __HAL_ADC_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) \
    ((GD32_HAL_ADC_GetInterrupts((__HANDLE__)->GD32_INSTANCE) & \
      (__INTERRUPT__)) != 0U)
