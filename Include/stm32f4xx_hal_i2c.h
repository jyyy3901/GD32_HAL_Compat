...
#undef I2C1
#endif
#define I2C1 ((I2C_TypeDef *)(uintptr_t)STM32_I2C_INSTANCE_1)
#define I2C2 ((I2C_TypeDef *)(uintptr_t)STM32_I2C_INSTANCE_2)

#define I2C1_EV_IRQn ((IRQn_Type)STM32_HAL_IRQ_I2C1_EV)
#define I2C1_ER_IRQn ((IRQn_Type)STM32_HAL_IRQ_I2C1_ER)
#define I2C2_EV_IRQn ((IRQn_Type)STM32_HAL_IRQ_I2C2_EV)
#define I2C2_ER_IRQn ((IRQn_Type)STM32_HAL_IRQ_I2C2_ER)
...
#define __HAL_I2C_ENABLE(__HANDLE__) \
    GD32_HAL_I2C_Enable((__HANDLE__)->GD32_INSTANCE)
#define __HAL_I2C_DISABLE(__HANDLE__) \
    GD32_HAL_I2C_Disable((__HANDLE__)->GD32_INSTANCE)
#define __HAL_I2C_ENABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_I2C_SetInterrupts((__HANDLE__)->GD32_INSTANCE, \
                               (__INTERRUPT__), 1)
#define __HAL_I2C_DISABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_I2C_SetInterrupts((__HANDLE__)->GD32_INSTANCE, \
                               (__INTERRUPT__), 0)
#define __HAL_I2C_GET_FLAG(__HANDLE__, __FLAG__) \
    ((GD32_HAL_I2C_GetFlags((__HANDLE__)->GD32_INSTANCE) & \
      (__FLAG__)) != 0U)
#define __HAL_I2C_CLEAR_ADDRFLAG(__HANDLE__) \
    GD32_HAL_I2C_ClearAddress((__HANDLE__)->GD32_INSTANCE)
