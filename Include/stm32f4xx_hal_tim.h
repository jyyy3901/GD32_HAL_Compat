...
#define TIM1_TRG_COM_TIM11_IRQn ((IRQn_Type)STM32_HAL_IRQ_TIM1_TRG_TIM11)
#define TIM1_CC_IRQn            ((IRQn_Type)STM32_HAL_IRQ_TIM1_CC)
#define TIM2_IRQn               ((IRQn_Type)STM32_HAL_IRQ_TIM2)
#define TIM3_IRQn               ((IRQn_Type)STM32_HAL_IRQ_TIM3)
#define TIM4_IRQn               ((IRQn_Type)STM32_HAL_IRQ_TIM4)
#define TIM5_IRQn               ((IRQn_Type)STM32_HAL_IRQ_TIM5)
...
#define HAL_TIM_ERROR_INVALID_PARAM 0x00000001U
#define HAL_TIM_ERROR_UNSUPPORTED   0x00000002U
#define HAL_TIM_ERROR_DMA           0x00000004U
...
#define __HAL_TIM_ENABLE(__HANDLE__) \
    GD32_HAL_TIMER_Enable((__HANDLE__)->GD32_INSTANCE)
#define __HAL_TIM_DISABLE(__HANDLE__) \
    GD32_HAL_TIMER_DisableIfIdle((__HANDLE__)->GD32_INSTANCE)
#define __HAL_TIM_ENABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_TIMER_SetInterrupt((__HANDLE__)->GD32_INSTANCE, (__INTERRUPT__), 1)
#define __HAL_TIM_DISABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_TIMER_SetInterrupt((__HANDLE__)->GD32_INSTANCE, (__INTERRUPT__), 0)
#define __HAL_TIM_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) \
    (GD32_HAL_TIMER_GetInterrupts((__HANDLE__)->GD32_INSTANCE) & (__INTERRUPT__))
#define __HAL_TIM_GET_FLAG(__HANDLE__, __FLAG__) \
    GD32_HAL_TIMER_GetFlag((__HANDLE__)->GD32_INSTANCE, (__FLAG__))
#define __HAL_TIM_CLEAR_FLAG(__HANDLE__, __FLAG__) \
    GD32_HAL_TIMER_ClearFlag((__HANDLE__)->GD32_INSTANCE, (__FLAG__))
#define __HAL_TIM_CLEAR_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_TIMER_ClearFlag((__HANDLE__)->GD32_INSTANCE, (__INTERRUPT__))
#define __HAL_TIM_ENABLE_DMA(__HANDLE__, __DMA__) \
    GD32_HAL_TIMER_SetDMARequest((__HANDLE__)->GD32_INSTANCE, \
...
#define __HAL_TIM_SET_COUNTER(__HANDLE__, __COUNTER__) \
    GD32_HAL_TIMER_SetCounter((__HANDLE__)->GD32_INSTANCE, (__COUNTER__))
#define __HAL_TIM_GET_COUNTER(__HANDLE__) \
    GD32_HAL_TIMER_GetCounter((__HANDLE__)->GD32_INSTANCE)
#define __HAL_TIM_SET_AUTORELOAD(__HANDLE__, __AUTORELOAD__) \
    do { \
        GD32_HAL_TIMER_SetAutoReload((__HANDLE__)->GD32_INSTANCE, (__AUTORELOAD__)); \
        if ((__AUTORELOAD__) <= 0xFFFFU) { (__HANDLE__)->Init.Period = (__AUTORELOAD__); } \
    } while (0U)
#define __HAL_TIM_GET_AUTORELOAD(__HANDLE__) \
    GD32_HAL_TIMER_GetAutoReload((__HANDLE__)->GD32_INSTANCE)
#define __HAL_TIM_SET_PRESCALER(__HANDLE__, __PRESC__) \
    GD32_HAL_TIMER_SetPrescaler((__HANDLE__)->GD32_INSTANCE, (__PRESC__))
#define __HAL_TIM_GET_PRESCALER(__HANDLE__) \
    GD32_HAL_TIMER_GetPrescaler((__HANDLE__)->GD32_INSTANCE)
#define __HAL_TIM_SET_COMPARE(__HANDLE__, __CHANNEL__, __COMPARE__) \
    GD32_HAL_TIMER_SetCompare((__HANDLE__)->GD32_INSTANCE, \
                              (uint8_t)((__CHANNEL__) >> 2U), (__COMPARE__))
#define __HAL_TIM_GET_COMPARE(__HANDLE__, __CHANNEL__) \
    GD32_HAL_TIMER_GetCompare((__HANDLE__)->GD32_INSTANCE, \
                              (uint8_t)((__CHANNEL__) >> 2U))

#define IS_TIM_INSTANCE(INSTANCE) \
    (GD32_HAL_ResolveInstance((uintptr_t)(INSTANCE), GD32_HAL_RESOURCE_TIMER) != NULL)
