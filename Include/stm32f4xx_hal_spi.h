...
#define __HAL_SPI_ENABLE(__HANDLE__) \
    GD32_HAL_SPI_Enable((__HANDLE__)->GD32_INSTANCE)
#define __HAL_SPI_DISABLE(__HANDLE__) \
    GD32_HAL_SPI_Disable((__HANDLE__)->GD32_INSTANCE)
#define __HAL_SPI_ENABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_SPI_SetInterrupts((__HANDLE__)->GD32_INSTANCE, \
                               (__INTERRUPT__), 1)
#define __HAL_SPI_DISABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_SPI_SetInterrupts((__HANDLE__)->GD32_INSTANCE, \
                               (__INTERRUPT__), 0)
#define __HAL_SPI_GET_FLAG(__HANDLE__, __FLAG__) \
    ((GD32_HAL_SPI_GetFlags((__HANDLE__)->GD32_INSTANCE) & \
      (__FLAG__)) != 0U)
