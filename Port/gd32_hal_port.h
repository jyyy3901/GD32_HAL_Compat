...
/*
 * 本文件是兼容 API 与 GD32 SPL 之间唯一允许直接暴露厂商定义的边界。
 * 上层 HAL 文件不得依赖 GD32 寄存器布局。
 */
...
#define GD32_HAL_SPI0_ADDRESS 0x40013800UL
...
/* 先保存 GD32 IRQ 数值，供公共头文件安全覆盖 STM32 风格名称。 */
enum
{
    GD32_HAL_USART0_IRQn_VALUE = USART0_IRQn,
    GD32_HAL_USART1_IRQn_VALUE = USART1_IRQn,
    GD32_HAL_USART2_IRQn_VALUE = USART2_IRQn,
    GD32_HAL_UART3_IRQn_VALUE = UART3_IRQn,
    GD32_HAL_UART4_IRQn_VALUE = UART4_IRQn
};

enum
{
    GD32_HAL_TIMER0_BRK_TIMER8_IRQn_VALUE = TIMER0_BRK_TIMER8_IRQn,
    GD32_HAL_TIMER0_UP_TIMER9_IRQn_VALUE = TIMER0_UP_TIMER9_IRQn,
    GD32_HAL_TIMER0_TRG_CMT_TIMER10_IRQn_VALUE = TIMER0_TRG_CMT_TIMER10_IRQn,
    GD32_HAL_TIMER0_CHANNEL_IRQn_VALUE = TIMER0_Channel_IRQn,
    GD32_HAL_TIMER1_IRQn_VALUE = TIMER1_IRQn,
    GD32_HAL_TIMER2_IRQn_VALUE = TIMER2_IRQn,
    GD32_HAL_TIMER3_IRQn_VALUE = TIMER3_IRQn,
    GD32_HAL_TIMER7_BRK_TIMER11_IRQn_VALUE = TIMER7_BRK_TIMER11_IRQn,
    GD32_HAL_TIMER7_UP_TIMER12_IRQn_VALUE = TIMER7_UP_TIMER12_IRQn,
    GD32_HAL_TIMER7_TRG_CMT_TIMER13_IRQn_VALUE = TIMER7_TRG_CMT_TIMER13_IRQn,
    GD32_HAL_TIMER7_CHANNEL_IRQn_VALUE = TIMER7_Channel_IRQn,
    GD32_HAL_TIMER4_IRQn_VALUE = TIMER4_IRQn,
    GD32_HAL_TIMER5_IRQn_VALUE = TIMER5_IRQn,
    GD32_HAL_TIMER6_IRQn_VALUE = TIMER6_IRQn
};

enum
{
    GD32_HAL_ADC0_1_IRQn_VALUE = ADC0_1_IRQn
};

enum
{
    GD32_HAL_I2C0_EV_IRQn_VALUE = I2C0_EV_IRQn,
    GD32_HAL_I2C0_ER_IRQn_VALUE = I2C0_ER_IRQn,
    GD32_HAL_I2C1_EV_IRQn_VALUE = I2C1_EV_IRQn,
    GD32_HAL_I2C1_ER_IRQn_VALUE = I2C1_ER_IRQn,
    GD32_HAL_SPI0_IRQn_VALUE = SPI0_IRQn,
    GD32_HAL_SPI1_IRQn_VALUE = SPI1_IRQn,
    GD32_HAL_SPI2_IRQn_VALUE = SPI2_IRQn
};
...
int GD32_HAL_TIMER_ResolveITR(uint32_t timer_address,
                              uint8_t stm_itr,
                              uint8_t *gd_itr);
