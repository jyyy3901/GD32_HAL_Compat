...
#define USART1 ((USART_TypeDef *)(uintptr_t)GD32_HAL_USART0_ADDRESS)
#define USART2 ((USART_TypeDef *)(uintptr_t)GD32_HAL_USART1_ADDRESS)
#define USART3 ((USART_TypeDef *)(uintptr_t)GD32_HAL_USART2_ADDRESS)
#define UART4  ((USART_TypeDef *)(uintptr_t)GD32_HAL_UART3_ADDRESS)
#define UART5  ((USART_TypeDef *)(uintptr_t)GD32_HAL_UART4_ADDRESS)

/* 保存值来自 Port 头文件，避免 GD32 零起始命名被宏递归改写。 */
#define USART1_IRQn ((IRQn_Type)GD32_HAL_USART0_IRQn_VALUE)
#define USART2_IRQn ((IRQn_Type)GD32_HAL_USART1_IRQn_VALUE)
#define USART3_IRQn ((IRQn_Type)GD32_HAL_USART2_IRQn_VALUE)
#define UART4_IRQn  ((IRQn_Type)GD32_HAL_UART3_IRQn_VALUE)
#define UART5_IRQn  ((IRQn_Type)GD32_HAL_UART4_IRQn_VALUE)
...
#define __HAL_UART_GET_FLAG(__HANDLE__, __FLAG__) \
    (GD32_HAL_UART_GetFlag((uint32_t)(uintptr_t)((__HANDLE__)->Instance), \
                           (GD32_HAL_UARTFlag)(__FLAG__)) != 0U)
#define __HAL_UART_CLEAR_FLAG(__HANDLE__, __FLAG__) \
    GD32_HAL_UART_ClearFlag((uint32_t)(uintptr_t)((__HANDLE__)->Instance), \
                            (GD32_HAL_UARTFlag)(__FLAG__))
#define __HAL_UART_CLEAR_PEFLAG(__HANDLE__) \
    GD32_HAL_UART_ClearErrors((uint32_t)(uintptr_t)((__HANDLE__)->Instance))
#define __HAL_UART_CLEAR_FEFLAG(__HANDLE__) __HAL_UART_CLEAR_PEFLAG(__HANDLE__)
#define __HAL_UART_CLEAR_NEFLAG(__HANDLE__) __HAL_UART_CLEAR_PEFLAG(__HANDLE__)
#define __HAL_UART_CLEAR_OREFLAG(__HANDLE__) __HAL_UART_CLEAR_PEFLAG(__HANDLE__)
#define __HAL_UART_CLEAR_IDLEFLAG(__HANDLE__) __HAL_UART_CLEAR_PEFLAG(__HANDLE__)
#define __HAL_UART_FLUSH_DRREGISTER(__HANDLE__) \
    ((void)GD32_HAL_UART_ReadData((uint32_t)(uintptr_t)((__HANDLE__)->Instance)))
#define __HAL_UART_ENABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_UART_SetInterrupt((uint32_t)(uintptr_t)((__HANDLE__)->Instance), \
...
#define __HAL_UART_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_UART_IsInterruptEnabled((uint32_t)(uintptr_t)((__HANDLE__)->Instance), \
                                     (GD32_HAL_UARTInterrupt)(__INTERRUPT__))
#define __HAL_UART_ENABLE(__HANDLE__) \
    GD32_HAL_UART_Enable((uint32_t)(uintptr_t)((__HANDLE__)->Instance))
#define __HAL_UART_DISABLE(__HANDLE__) \
    GD32_HAL_UART_Disable((uint32_t)(uintptr_t)((__HANDLE__)->Instance))
...
#define IS_UART_INSTANCE(INSTANCE) \
    GD32_HAL_UART_IsInstance((uint32_t)(uintptr_t)(INSTANCE))
#define IS_UART_HWFLOW_INSTANCE(INSTANCE) \
    GD32_HAL_UART_IsFlowControlCapable((uint32_t)(uintptr_t)(INSTANCE))
