...
#define GD32_DMA0_CHANNEL0 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA0_CHANNEL0_ADDRESS)
#define GD32_DMA0_CHANNEL1 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA0_CHANNEL1_ADDRESS)
#define GD32_DMA0_CHANNEL2 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA0_CHANNEL2_ADDRESS)
#define GD32_DMA0_CHANNEL3 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA0_CHANNEL3_ADDRESS)
#define GD32_DMA0_CHANNEL4 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA0_CHANNEL4_ADDRESS)
#define GD32_DMA0_CHANNEL5 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA0_CHANNEL5_ADDRESS)
#define GD32_DMA0_CHANNEL6 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA0_CHANNEL6_ADDRESS)
#define GD32_DMA1_CHANNEL0 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA1_CHANNEL0_ADDRESS)
#define GD32_DMA1_CHANNEL1 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA1_CHANNEL1_ADDRESS)
#define GD32_DMA1_CHANNEL2 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA1_CHANNEL2_ADDRESS)
#define GD32_DMA1_CHANNEL3 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA1_CHANNEL3_ADDRESS)
#define GD32_DMA1_CHANNEL4 ((DMA_Stream_TypeDef *)(uintptr_t)GD32_HAL_DMA1_CHANNEL4_ADDRESS)
...
#define __HAL_DMA_ENABLE(__HANDLE__) \
    GD32_HAL_DMA_Enable((uint32_t)(uintptr_t)((__HANDLE__)->Instance))
#define __HAL_DMA_DISABLE(__HANDLE__) \
    GD32_HAL_DMA_Disable((uint32_t)(uintptr_t)((__HANDLE__)->Instance))
#define __HAL_DMA_GET_COUNTER(__HANDLE__) \
    GD32_HAL_DMA_GetRemaining((uint32_t)(uintptr_t)((__HANDLE__)->Instance))
#define __HAL_DMA_SET_COUNTER(__HANDLE__, __COUNTER__) \
    GD32_HAL_DMA_SetRemaining((uint32_t)(uintptr_t)((__HANDLE__)->Instance), (__COUNTER__))
#define __HAL_DMA_GET_FLAG(__HANDLE__, __FLAG__) \
    GD32_HAL_DMA_GetFlag((uint32_t)(uintptr_t)((__HANDLE__)->Instance), (__FLAG__))
#define __HAL_DMA_CLEAR_FLAG(__HANDLE__, __FLAG__) \
    GD32_HAL_DMA_ClearFlag((uint32_t)(uintptr_t)((__HANDLE__)->Instance), (__FLAG__))
#define __HAL_DMA_ENABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_DMA_SetInterrupt((uint32_t)(uintptr_t)((__HANDLE__)->Instance), (__INTERRUPT__), 1)
#define __HAL_DMA_DISABLE_IT(__HANDLE__, __INTERRUPT__) \
    GD32_HAL_DMA_SetInterrupt((uint32_t)(uintptr_t)((__HANDLE__)->Instance), (__INTERRUPT__), 0)
#define __HAL_DMA_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__) \
    (GD32_HAL_DMA_GetInterrupts((uint32_t)(uintptr_t)((__HANDLE__)->Instance)) & (__INTERRUPT__))
...
#define IS_DMA_STREAM_ALL_INSTANCE(INSTANCE) \
    GD32_HAL_DMA_IsInstance((uint32_t)(uintptr_t)(INSTANCE))
