...
static uint32_t I2C_Address(const I2C_HandleTypeDef *hi2c)
{
    ...
    if ((hi2c != NULL) && (hi2c->GD32_RESOURCE != NULL) &&
        (hi2c->GD32_RESOURCE->stm32_instance == (uintptr_t)hi2c->Instance))
    {
        return hi2c->GD32_INSTANCE;
    }
    resource = (hi2c != NULL) ?
        GD32_HAL_ResolveInstance((uintptr_t)hi2c->Instance,
                                 GD32_HAL_RESOURCE_I2C) : NULL;
...
HAL_StatusTypeDef HAL_I2C_Init(I2C_HandleTypeDef *hi2c)
{
    ...
    resource = GD32_HAL_ResolveInstance((uintptr_t)hi2c->Instance,
                                        GD32_HAL_RESOURCE_I2C);
    if (resource == NULL)
    {
        GD32_HAL_ErrorHook(GD32_HAL_PORT_ERROR_I2C_INVALID_CONFIG,
                           (uint32_t)(uintptr_t)hi2c->Instance);
        return HAL_ERROR;
    }
    hi2c->GD32_RESOURCE = resource;
    hi2c->GD32_INSTANCE = resource->gd32_instance;
    hi2c->GD32_IRQ_NUMBER = resource->gd32_irq;
    if (I2C_FillConfig(hi2c, &config) == 0)
    {
        GD32_HAL_ErrorHook(GD32_HAL_PORT_ERROR_I2C_INVALID_CONFIG,
                           hi2c->GD32_INSTANCE);
...
HAL_StatusTypeDef HAL_I2C_DeInit(I2C_HandleTypeDef *hi2c)
{
    ...
    hi2c->Mode = HAL_I2C_MODE_NONE;
    hi2c->ErrorCode = HAL_I2C_ERROR_NONE;
    hi2c->GD32_INSTANCE = 0U;
    hi2c->GD32_IRQ_NUMBER = -1;
    hi2c->GD32_RESOURCE = NULL;
    __HAL_UNLOCK(hi2c);
    return HAL_OK;
}
